...
using System.Text;
using WineCellar.Blazor.UI.Components.Modal;
...
namespace WineCellar.Blazor.UI.Pages
{
    public partial class BlazoredModal : IDisposable
    {
        ...
        private async void ShowModal(string title, RenderFragment content, ModalParameters parameters, ModalOptions option)
        {
            Title = title;
            Content = content;
        ...
        private void SetModalOption(ModalOptions options)
        {
